...
public class FlywaySchemaHistoryDao extends DAOImpl<FlywaySchemaHistoryRecord, meta.tables.pojos.FlywaySchemaHistory, Integer> {

    /**
     * Create a new FlywaySchemaHistoryDao without any configuration
     */
    public FlywaySchemaHistoryDao() {
        super(FlywaySchemaHistory.FLYWAY_SCHEMA_HISTORY, meta.tables.pojos.FlywaySchemaHistory.class);
    }
    ...
    public FlywaySchemaHistoryDao(Configuration configuration) {
        super(FlywaySchemaHistory.FLYWAY_SCHEMA_HISTORY, meta.tables.pojos.FlywaySchemaHistory.class, configuration);
    }
     ...
     */
    @Override
    protected Integer getId(meta.tables.pojos.FlywaySchemaHistory object) {
     ...
     */
    public List<meta.tables.pojos.FlywaySchemaHistory> fetchByInstalledRank(Integer... values) {
     ...
     */
    public meta.tables.pojos.FlywaySchemaHistory fetchOneByInstalledRank(Integer value) {
     ...
     */
    public List<meta.tables.pojos.FlywaySchemaHistory> fetchByVersion(String... values) {
     ...
     */
    public List<meta.tables.pojos.FlywaySchemaHistory> fetchByDescription(String... values) {
     ...
     */
    public List<meta.tables.pojos.FlywaySchemaHistory> fetchByType(String... values) {
     ...
     */
    public List<meta.tables.pojos.FlywaySchemaHistory> fetchByScript(String... values) {
     ...
     */
    public List<meta.tables.pojos.FlywaySchemaHistory> fetchByChecksum(Integer... values) {
     ...
     */
    public List<meta.tables.pojos.FlywaySchemaHistory> fetchByInstalledBy(String... values) {
     ...
     */
    public List<meta.tables.pojos.FlywaySchemaHistory> fetchByInstalledOn(Timestamp... values) {
     ...
     */
    public List<meta.tables.pojos.FlywaySchemaHistory> fetchByExecutionTime(Integer... values) {
     ...
     */
    public List<meta.tables.pojos.FlywaySchemaHistory> fetchBySuccess(Boolean... values) {
